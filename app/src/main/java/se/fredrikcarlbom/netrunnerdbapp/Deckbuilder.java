...
public class Deckbuilder extends Activity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.deckbuilder, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_deckbuilder, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((Deckbuilder) activity).onSectionAttached(
